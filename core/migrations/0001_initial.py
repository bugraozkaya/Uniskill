    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('scheduled', 'Scheduled (Planlandı)'), ('completed', 'Completed (Tamamlandı)'), ('cancelled', 'Cancelled (İptal)')], default='scheduled', max_length=20)),
